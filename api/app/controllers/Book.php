...
//        $cancel_req = $this->Book_model->user_cancel_request($data_req, $dec_data->id_driver);
    ...
    function driver_finish_transaksi_mmart_post(){
        ...
        $url_foto = '/home/XXXXXXX/public_html/asset/berkas_struk_mmart/';
    ...
    function driver_finish_transaksi_mfood_post(){
        ...
        $url_foto = '/home/XXXXXX/public_html/asset/berkas_struk_mfood/';
        $statImg = $this->save_image($url_foto, $dec_data->foto_struk, $adate);
...
// fungsi dari BookService.java -->  Call<GetDataMserviceResponseJson>
    ...
    function get_data_pulsa_get(){
        ...
        $mserv_ac = $this->Book_model->get_data_pulsa();
        $message = array(
            'message' => 'data mservice ac',
            'data' => $mserv_ac
        );
...
//            );
    ...
    function cancel_transaction_get($idDriver, $idUser, $idTrans){
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "http://YOUR_URL/api/book/send_cancel_signal/".$idDriver."/".$idUser."/".$idTrans);

...
//        $this->response($data, 200);
    ...
    function update_profile_post() {
        ...
        $url_foto = '/home/XXXXXXXX/public_html/admin/fotodriver/';
...
//        $hasil= $this->db->get();
    ...
    function check_version_post(){
        ...
        // }else{
            ...
            if($getVer > $dec_data->version){
                    $message = array(
                        'new_version' => 'yes',
                        'message' => 'The latest version of the GO-TAXI DRIVER application is available now on PlayStore. Click "Update" to continue!',
                        'data' => []
                    );
                    $this->response($message, 200);
            }else {
    ...
    function verifikasi_topup_post(){
        ...
        $url_foto = '/home/XXXXXXXX/public_html/asset/berkas_topup/driver/';

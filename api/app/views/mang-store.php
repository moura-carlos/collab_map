        ...
        <header id="header" role="banner">    
          ...
          <div class="main-nav fixed-menu">
            ...
            <div class="col-md-2 col-xs-6 col-xs-push-1 col-md-push-1 text-center">
                <img src="<?= base_url() ?>asset/images/logo_header/mstore.png" width="60%" style="margin-top:20px">
            </div>
...
<!-- <div id="main-slider" class="carousel slide" data-ride="carousel">
  ...
  <div id="main-slider" class="carousel slide" data-ride="carousel"  style="height: 100vh">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img class="img-responsive" src="<?php echo base_url() ?>asset/images/slider/mstore/s1.jpg" alt="slider" style="height: 100vh">            
      </div>
      <!-- <div class="item">
        <img class="img-responsive" src="<?php echo base_url() ?>asset/images/slider/nf.Banner2.png" alt="slider">  
...
<section class="section" id="layanan_isi_detail1" style="background: white;">
  <div class="trigger myContent">
    <div class="container animated" style="padding-bottom: 10%;">
      

    <div class="col-md-12 col-xs-12">
      <div class="col-md-12 col-xs-12" style="padding: 30px 0;">
        <h2>MENGAPA M-STORE</h2>
        
        </div>
        <div class="col-md-12 col-xs-12 fitur_mmart" style="padding: 30px 0;">
          <div class="col-md-3 col-xs-6">
            <center><img src="<?php echo base_url() ?>asset/images/kelebihan/mstore/1.png">
              <h1 style="margin: 0 auto;"><font color="black">AMAN</font></h1>
              </center>
            </div>
            <div class="col-md-3 col-xs-6 fitur_mmart_detail">
              <center><img src="<?php echo base_url() ?>asset/images/kelebihan/mstore/2.png">
               <h1 style="margin: 0 auto;"><font color="black">BANYAK PILIHAN</font></h1></center>
             </div>
             <div class="col-md-3 col-xs-6 fitur_mmart_detail">
              <center><img src="<?php echo base_url() ?>asset/images/kelebihan/mstore/3.png">
               <h1 style="margin: 0 auto;"><font color="black">MUDAH</font></h1></center>
             </div>
             <div class="col-md-3 col-xs-6 fitur_mmart_detail">
              <center><img src="<?php echo base_url() ?>asset/images/kelebihan/mstore/4.png">
               <h1 style="margin: 0 auto;"><font color="black">RESPON CEPAT</font></h1></center>
             </div>
                      ...
                      <div id="how-to-slide1" class="carousel slide " data-interval="0">
                        ...
                        <div class="carousel-inner" role="listbox">
                          <div class="item truknya active">
                            <img src="<?php echo base_url() ?>asset/images/workflow/mstore/1.png"  alt="Truk">
                          </div>
                          <div class="item truknya">
                            <img src="<?php echo base_url() ?>asset/images/workflow/mstore/2.png"  alt="Truk">
                          </div>
                          <div class="item truknya">
                            <img src="<?php echo base_url() ?>asset/images/workflow/mstore/3.png" alt="Truk">
                          </div>
                          <div class="item truknya">
                            <img src="<?php echo base_url() ?>asset/images/workflow/mstore/4.png"  alt="Truk">
                          </div>
                          <div class="item truknya">
                            <img src="<?php echo base_url() ?>asset/images/workflow/mstore/5.png"alt="Truk">
                          </div>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                          ...
                          <li role="presentation" data-target="#how-to-slide1" data-slide-to="1" class="">
                            ...
                            <div class="col-md-3" style="margin-top: 90px;">
                              <h2>Cara Menggunakan M-STORE</h2>
                            </div>
                          </div>
                        </div>
                      </section>
                      ...
                      <section class="section" style="background:transparent;">
                        <div class="myContent trigger">
                          <div class="container animated">
                            ...
                            <div class="col-md-6 pull-right col-xs-12 join_mmart">
                             <div class="col-md-6">

                             </div>

                             <div class="col-md-12" style="padding: 40px 30px;">
                              <p class="join_mmart_detail1">Ingin Bergabung dengan M-STORE?</p>
                              <p class="join_mmart_detail2">Jadilah mitra M-JEK dan dapatkan keuntungannya</p>
                            </div>
                            <div class="col-xs-12  see_full_align wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s;">
                              <a href="<?php echo base_url() ?>index.php/c_utama/join_mangcar" class="btn btn-info btn btn-lg  Seo_section_testbtn">JOIN WITH US</a>
                            </div>
                          </div>
                     ...
                     <div class="animated container">
                      ...
                      <div class="col-md-6 col-xs-12" style="margin-top:50px;">
                        <div class="layanan_isi-download1">
                          <p style="color:#0a0a0a">Download MANG-JEK <font color='#0D6485'>Mobile App</font> today</p>
                        </div>

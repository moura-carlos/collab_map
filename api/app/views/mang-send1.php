...
<head>
    ...
    <title>Mang-send | Mang-Jek</title>
      ...
      <div class="container">   
        ...
        <!-- /#sidebar-wrapper -->
                  ...
                  <div class="col-md-4 col-xs-8">
                   <h1 class="main-logo">
                      <a href="#" style="background:url(<?php echo base_url() ?>asset/images/logo-layanan/H-MSEND.png)
...
<section id="layanan_isi_detail1" style="background:#FFCC00">
		<div class="container">
			<div class="about">
				<div class="row">
					<div class="col-md-3">
						<img class="img-responsive" src="<?php echo base_url() ?>asset/images/logo-layanan/H-MSEND.png" alt="member-1">
						<h2>UNGGUL1</h2>
			...
			<div class="about">
				...
				<div id="mi-slider" class="mi-slider">
					<ul style="margin-bottom: -30px; margin-left: -50px;">
						<li><a href="#"><img src="<?php echo base_url() ?>asset/images/logo-layanan/MSEND1.png" alt="img01"><center><h4>Pilih1</h4></center></a></li>
						
					</ul>
	
					<ul style="margin-bottom: -30px; margin-left: -50px;">
						<li><a href="#"><img src="<?php echo base_url() ?>asset/images/logo-layanan/MSEND2.png" alt="img01"><h4>Pilih2</h4></a></li>
						
					</ul>

					<ul style="margin-bottom: -30px; margin-left: -50px;">
						<li><a href="#"><img src="<?php echo base_url() ?>asset/images/logo-layanan/MSEND3.png" alt="img01"><h4>Pilih3</h4></a></li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="layanan_isi-join-judul">
					<p>Join With <font color='#FFCC00'>M-SEND</font> in MANG-JEK Now</p>
				</div>

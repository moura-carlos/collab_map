        ...
        <header id="header" role="banner">    
          ...
          <div class="main-nav fixed-menu">
            ...
            <div class="col-md-2 col-xs-6 col-xs-push-1 col-md-push-1 text-center">
                <img src="<?= base_url() ?>asset/images/logo_header/mbox.png" width="60%" style="margin-top:20px">
            </div>
...
<!-- <div id="main-slider" class="carousel slide" data-ride="carousel">
  ...
  <div id="main-slider" class="carousel slide" data-ride="carousel"  style="height: 100vh">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img class="img-responsive" src="<?php echo base_url() ?>asset/images/slider/mbox/s1.jpg" alt="slider" style="height: 100vh">            
...
<section class="section " id="layanan_isi_detail1"   style="background: #FFF;">
                <div class="trigger myContent" >
                  <div class="container animated slideInDown ">
                    <h2>Mengapa Menggunakan Aplikasi M-BOX?</h2>
                    ...
                    <div class="col-md-3 col-sm-6" style="margin-top: 30px;">
                      ...
                      <div class="judul_unggul" style="background:url(<?php echo base_url() ?>asset/images/zigzag-line.png);    background-position: bottom center;     background-size: 100%; background-repeat:no-repeat; margin: 0 auto 20px;"></center>
                        <center><img class="img-responsive" src="<?php echo base_url() ?>asset/images/kelebihan/mbox/1.png" alt="member-1" style="width: 100%; max-width: 134px;">
                          <h2 style="margin-top: 0px; font-size: 25px; font-weight: bold; color:#0B405C;">Barang Aman</h2>
                      ...
                      <div class="col-md-3 col-sm-6" style="margin-top: 30px;">
                        ...
                        <div class="judul_unggul" style="background:url(<?php echo base_url() ?>asset/images/zigzag-line.png);    background-position: bottom center;     background-size: 100%; background-repeat:no-repeat; margin: 0 auto 20px;"></center>
                          <center><img class="img-responsive" src="<?php echo base_url() ?>asset/images/kelebihan/mbox/2.png" alt="member-1" style="width: 100%; max-width: 134px;">
                            <h2 style="margin-top: 0px; font-size: 25px; font-weight: bold; color:#0B405C;">Cek Lokasi</h2>
                        ...
                        <div class="col-md-3 col-sm-6" style="margin-top: 30px;">
                          ...
                          <div class="judul_unggul" style="background:url(<?php echo base_url() ?>asset/images/zigzag-line.png);    background-position: bottom center;     background-size: 100%; background-repeat:no-repeat; margin: 0 auto 20px;"></center>
                            <center><img class="img-responsive" src="<?php echo base_url() ?>asset/images/kelebihan/mbox/3.png" alt="member-1" style="width: 100%; max-width: 134px;">
                              <h2 style="margin-top: 0px; font-size: 25px; font-weight: bold; color:#0B405C;">Harga Transparant</h2>
                          ...
                          <div class="col-md-3 col-sm-6" style="margin-top: 30px;">
                            ...
                            <div class="judul_unggul" style="background:url(<?php echo base_url() ?>asset/images/zigzag-line.png);    background-position: bottom center;     background-size: 100%; background-repeat:no-repeat; margin: 0 auto 20px;"></center>
                              <center><img class="img-responsive" src="<?php echo base_url() ?>asset/images/kelebihan/mbox/4.png" alt="member-1" style="width: 100%; max-width: 134px;">
                      ...
                      <div id="how-to-slide1" class="carousel slide " data-interval="0">
                        ...
                        <div class="carousel-inner" role="listbox">
                          <div class="item truknya active">
                            <img src="<?php echo base_url() ?>asset/images/workflow/mbox/1.png">
                          </div>
                          <div class="item truknya">
                            <img src="<?php echo base_url() ?>asset/images/workflow/mbox/2.png">
                          </div>
                          <div class="item truknya">
                            <img src="<?php echo base_url() ?>asset/images/workflow/mbox/3.png">
                          </div>
                          <div class="item truknya">
                            <img src="<?php echo base_url() ?>asset/images/workflow/mbox/4.png">
                          </div>
                          <div class="item truknya">
                            <img src="<?php echo base_url() ?>asset/images/workflow/mbox/5.png">
                          </div>
                          ...
                          <li role="presentation" data-target="#how-to-slide1" data-slide-to="1" class="">
                            ...
                            <li role="presentation" data-target="#how-to-slide1" data-slide-to="2" class="">
                              ...
                              <li role="presentation" data-target="#how-to-slide1" data-slide-to="3" class="">
                                ...
                                <a href="#5" aria-controls="settings" role="tab" data-toggle="tab" target="_top" aria-expanded="false">5
                                  <div class="ripple-wrapper"></div></a>
                                </li>
              ...
              <div class="trigger myContent">
               <div class="container animated">
                ...
                <div class="col-md-8 col-xs-12">
                  <div class="layanan_isi-download3" style="width: 400px;">
                    <p style="color:white;">Download MANG-JEK <font color='#FFCC00'>Mobile App</font> today</p>
                  </div>
                  ...
                  <div class="layanan_isi-download2" style="margin-top:20px">
                    ...
                    <div class="col-md-6 col-xs-12" style="margin-bottom: 10%" >
                      ...
                      <section class="section fp-auto-height" style="background: #252525; opacity:0.9;">
                        <div class="trigger myContent">
                          <div class="container animated">
                            <div class="text-center ">
                              ...
                              <div class="col-xs-12  ">
                                <p style="font-size:30px; ">BERGABUNGLAH DENGAN M-BOX</p>
                                <p>Pengirimian antar kota antar provinsi</p>
                              </div>
                              <div class="col-xs-12  see_full_align wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s;">
                                <a href="<?php echo base_url()?>index.php/c_utama/join_mangbox" class="btn btn-info btn btn-lg  Seo_section_testbtn">JOIN DRIVER</a>
                              </div>
                            </div>
                          </div>
                        </div>

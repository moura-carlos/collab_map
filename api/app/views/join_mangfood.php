          ...
          <div class="col-md-12">
              <div class="tipe_mfood">
                 ...
                 <center>
                    ...
                    <a href="<?php echo base_url() ?>index.php/c_utama/join_mangfood_company" class="btn btn-primary">Daftar Company<div class="ripple-wrapper"></div></a>
                    <a href="<?php echo base_url() ?>index.php/c_utama/join_mangfood_personal" class="btn btn-primary">Daftar Personal<div class="ripple-wrapper"></div></a></center>
              </div>
          </div>

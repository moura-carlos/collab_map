...
<head>
    ...
    <title>Mang-food | Mang-Jek</title>
...
<section id="layanan_isi_detail1" style="background:#FFCC00">
		<div class="container">
			<div class="about">
				<div class="row">
					<div class="col-md-3">
						<img class="img-responsive" src="<?php echo base_url() ?>asset/images/logo-layanan/H-MFOOD.png" alt="member-1">
						<h2>UNGGUL1</h2>
			...
			<div class="about">
				...
				<div id="mi-slider" class="mi-slider">
					<ul style="margin-bottom: -30px; margin-left: -50px;">
						<li><a href="#"><img src="<?php echo base_url() ?>asset/images/logo-layanan/MFOOD1.png" alt="img01"><center><h4>Pilih1</h4></center></a></li>
						
					</ul>
	
					<ul style="margin-bottom: -30px; margin-left: -50px;">
						<li><a href="#"><img src="<?php echo base_url() ?>asset/images/logo-layanan/MFOOD2.png" alt="img01"><h4>Pilih2</h4></a></li>
						
					</ul>

					<ul style="margin-bottom: -30px; margin-left: -50px;">
						<li><a href="#"><img src="<?php echo base_url() ?>asset/images/logo-layanan/MFOOD3.png" alt="img01"><h4>Pilih3</h4></a></li>

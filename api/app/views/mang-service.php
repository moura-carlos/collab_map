        ...
        <header id="header" role="banner">    
          ...
          <div class="main-nav fixed-menu">
            ...
            <div class="col-md-2 col-xs-6 col-xs-push-1 col-md-push-1 text-center">
                <img src="<?= base_url() ?>asset/images/logo_header/mservice.png" width="60%" style="margin-top:20px">
            </div>
  ...
  <div id="main-slider" class="carousel slide" data-ride="carousel" style="height: 100vh">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img class="img-responsive" src="<?php echo base_url() ?>asset/images/slider/mservice/s1.jpg" alt="slider" style="height: 100vh">            
                      ...
                      <div id="how-to-slide1" class="carousel slide " data-interval="0">
                        ...
                        <div class="carousel-inner" role="listbox">
                          <div class="item truknya active">
                           <img src="<?php echo base_url() ?>asset/images/logo-layanan/MSERVICE1.png"  alt="Truk">
                         </div>
                         <div class="item truknya">
                          <img src="<?php echo base_url() ?>asset/images/logo-layanan/MSERVICE2-1.png"  alt="Truk">
                        </div>
                        <div class="item truknya">
                          <img src="<?php echo base_url() ?>asset/images/logo-layanan/MSERVICE2-2.png" alt="Truk">
                        </div>
                        <div class="item truknya">
                         <img src="<?php echo base_url() ?>asset/images/logo-layanan/MSERVICE2-3.png" alt="Truk">
                       </div>
                       <div class="item truknya">
                        <img src="<?php echo base_url() ?>asset/images/logo-layanan/MSERVICE4.png" alt="Truk">
                      </div>
                      <div class="item truknya">
                       <img src="<?php echo base_url() ?>asset/images/logo-layanan/MSERVICE5.png" alt="Truk">
                     </div>
                     <div class="item truknya">
                      <img src="<?php echo base_url() ?>asset/images/logo-layanan/MSERVICE6.png" alt="Truk">
                    </div>
                      ...
                      <li role="presentation" data-target="#how-to-slide1" data-slide-to="2" class="">
                        ...
                        <li role="presentation" data-target="#how-to-slide1" data-slide-to="3" class="">
                          ...
                          <li role="presentation" data-target="#how-to-slide1" data-slide-to="4" class="">
                            ...
                            <li role="presentation" data-target="#how-to-slide1" data-slide-to="5" class="">
                              <a href="#profile" aria-controls="profile" role="tab" data-toggle="tab" target="_top" aria-expanded="false">6
                                <div class="ripple-wrapper"></div></a>
                              </li>
                              <li role="presentation" data-target="#how-to-slide1" data-slide-to="6" class="">
                                <a href="#messages" aria-controls="messages" role="tab" data-toggle="tab" target="_top" aria-expanded="false">7
                                  <div class="ripple-wrapper"></div></a>
                                </li>
                              </ul>
                              ...
                              <div class="tab-content">
                                ...
                                <div role="tabpanel" class="box-desc tab-pane" id="6">
                                  <div class="row">
                                    <div class="col-md-8">
                                      <div class="info-kendaraan">
                                        <h3 class="normal-font">Pilih Layanan M-RIDE</h3>
                                ...
                                <div role="tabpanel" class="box-desc tab-pane" id="7">
                                  <div class="row">
                                    <div class="col-md-8">
                                      <div class="info-kendaraan">
                                        <h3 class="normal-font">Pilih Layanan M-RIDE</h3>
                          ...
                          <div class="col-md-3" style="margin-top: 90px;">
                            <h2>Cara Menggunakan M-SERVICE</h2>
                          </div>
                        </div>
                      </div>
                    </section>
...
<section class="row section" style="height: 100vh; background-image: url('<?= base_url()?>asset/images/screenshot/mservice/ss_service.jpg'); background-repeat:no-repeat; background-size: cover;
            ">
               <div class="container">
                 <div class="col-lg-6 col-md-6 col-xs-12 pull-right text-right">
                   <h1 style="font-size: 50px"><b>M-SERVICE HADIR DI</b></h1>
                   <h1>PALEMBANG • JAMBI • LAMPUNG</h1>

                   <h5>Segera bergabung dengan M-SERVICE di MANG-JEK</h5>
                   <button class="btn btn-warning btn-lg text-center">Gabung sebagai Teknisi</button>
                 </div>
               </div>
             </section>

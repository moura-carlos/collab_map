...
<header id="header" role="banner">    
    ...
    <div class="main-nav fixed-menu">
        ...
        <!-- /#sidebar-wrapper -->
                  ...
                  <div class="col-md-4 col-xs-8">
                   <h1 class="main-logo">
                    <a href="#" style="background:url(<?php echo base_url() ?>asset/images/logo-layanan/H-MCAR.png)
	...
	<section id="layanan_isi" style="margin-top:-15px;">
...
<section id="layanan_isi_detail1" style="margin-top: -20px;">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<h2 style="text-align: left; font-size:35px;">M-CAR – Cepat, Fleksibel, Mudah</h2>
        	<div class="line" style="margin-bottom: 20px;"></div>
        	<div class="join_mcar_desc" style="margin-bottom:50px; text-align:justify;">
        			<font color="black">Dengan memberikan kecepatan dan kemudahan pemesanan, penentuan destinasi yang fleksibel, dan yang terpenting, keamanan dan kenyamanan, M-CAR adalah solusinya.</font>
        	</div>
		</div>
	...
	<center></center>
		...
		<div class="col-xs-12 col-md-6 col-sm-6 join_mcar_foto">
			<img src="<?php echo base_url() ?>asset/images/gocar-join-value1.jpg">
			<h1 style="color:black;">Bergabunglah Dengan Gerakan Karya Anak Bangsa</h1>
		</div>
  ...
  <
		...
		<div class="container" style="padding-bottom: 10px;">
			<div class="row">
				...
				<div class="layanan_isi-join-judul">
					<p>Join With <font color='#FFCC00'>M-CAR</font> in MANG-JEK Now</p>
				</div>
    ...
    padding-bottom: 10px;
    border-radius: 5px;">
              <p><font color="black">Syarat dan Ketentuan:</font></p>
              <p><font color="black">1.Driver harus menyediakan mobil sendiri</font></p>
              <p><font color="black">2.Driver harus memiliki perangkat Android pribadi</font></p>
              <p><font color="black">3.Driver harus memiliki SIM A atau SIM B1 yang masih aktif setidaknya 6 bulan ke depan</font></p>
              ...
              <div class="col-md-6 form-group">
                <div></div>
					...
					<div class="datakendaraan">
						<h1 style="font-weight:bold; font-size:45px;">Data Kendaraan</h1>
						<hr>

    ...
    <!-- MENGAPA MANG-JEK -->
        ...
        <div style="background:#0D6485;">
            ...
            <div class="row">
                ...
                <div class="col-md-12 content">
                        <h2 class="section-title">MENGAPA <span class="inline">MANG-JEK</span></h2>
                        <div class="line"></div>
        ...
        <div class="col-md-12">
            <div class="row" >
                <div class="col-md-4 text-center image-border-hover">
                    ...
                    <p> 1. Memberikan kenyamanan Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                    </p>
                    </div>

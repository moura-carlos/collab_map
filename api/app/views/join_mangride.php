...
<section id="layanan_isi_detail1" style="margin-top: -20px;">
        ...
        <h2 style="    text-align: left; font-size:35px;">M-RIDE – Cepat, Fleksibel, Mudah</h2>
        <div class="line" style="margin-bottom: 20px;"></div>
        <div class="join_mride_desc">
        <font color="black">Dengan memberikan kecepatan dan kemudahan pemesanan, penentuan destinasi yang fleksibel, dan yang terpenting, keamanan dan kenyamanan, M-RIDE adalah solusinya.</font>
        </div>
        </div>
		...
		<div class="mbr-section__col col-xs-12 col-md-4 col-sm-12">
                <div class="mbr-section__container mbr-section__container--center mbr-section__container--middle">
                    <figure class="mbr-figure"><img src="<?php echo base_url() ?>asset/images/whatis.jpg" class="mbr-figure__img"></figure>
                </div>
                <div class="mbr-section__container mbr-section__container--middle">
                    <div class="mbr-header mbr-header--reduce mbr-header--center mbr-header--wysiwyg">
                        <h3><font color="#000">BOOTSTRAP 3</font></h3>
                    </div>
                </div>
  ...
  <
	...
	<section id="layanan_isi-join">
		<div class="container" style="padding-bottom: 10px;">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <div style="background:url('<?php echo base_url()?>asset/images/05_samping_form.jpg') no-repeat center center / cover;
    height: 700px;
    padding: 20px;
    margin-top: 30px;
    color: #9B9B9B;
    ...
    padding-bottom: 10px;
    border-radius: 5px;">
              <p><font color="black">Ketentuan:</font></p>
              <p><font color="black">1.Calon driver wajib memiliki android smartphone</font></p>
              <p><font color="black">2.Calon driver wajib memiliki SIM C aktif</font></p>
              <p><font color="black">3.Calon driver harus menyediakan motor dengan STNK aktif</font></p>

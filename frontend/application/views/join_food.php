...
<head>
    ...
    <title>REGISTER RESTAURANT | GOTAXI</title>
...
<header id="header" role="banner">
  ...
  <div class="main-nav fixed-menu">
            ...
            <div class="navbar-collapse collapse">
					...
					<li><a href="https://api.whatsapp.com/send?phone=+6282259939674&amp;text=Please%20leave it%20your%20message.....">Call Center</a></li>
                </ul>
            </div>
        </div>
    ...
    <div class="container" style="padding-bottom: 10px;">
      <div class="row">
        ...
        <div class="layanan_isi-join-judul" style="font-family:'Yanone Kaffeesatz', 'sans-serif';">
         <p>Sign Up Immediately <font color='#FFCC00'>Bar, Cafe, or Your Restaurant</font> in CollabMap</p>
        </div>
        ...
        <div class="layanan_isi-join-judul2-mride">
          <p style="font-family:'Yanone Kaffeesatz', 'sans-serif'; font-weight: bold; letter-spacing: 2px; margin-bottom: 10px;">
            REGISTRATION OF RESTAURANTS / BAR / KAFE
        ...
        <div class="col-md-12">
          ...
          <div class="datadiri">
             ...
             <h1 style="font-weight:bold; font-size:35px; letter-spacing: 2px;">GENERAL INFORMATION</h1>
              <hr>

              <div class="col-md-6 form-group">
                <label>Restaurant Owner's Name</label>
             ...
             <label>Leader's Name</label>
                <input type="text" placeholder="Example: Piter" name="nama_penanggung_jawab" class="form-control">
              </div>
            ...
            <hr>
              ...
              <div class="col-md-6 form-group">
               ...
               <div class="col-md-6 form-group">
                ...
                <input type="tel" placeholder="Restaurant phone number" name="telepon_restoran" class="form-control">
              </div>
              ...
              <div class="col-md-6 form-group">
                ...
                <select name="kategori" class="form-control">
                   <option default>Select Restaurant Category</option>
              ...
              <div class="col-md-12 form-group">
               ...
               <div class="col-md-6 form-group">
                 <label>Restaurant Description</label>
                  <textarea placeholder="please input your description" name="deskripsi_resto" rows="6" style="resize:none;" class="form-control"></textarea>
              </div>
              ...
              <div class="col-md-6 form-group">
                <label>Restaurant Photos<br>(Format File JPG Max: 1MB)</label>

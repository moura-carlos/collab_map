...
#login-form{width:350px; background:#FFF; margin:50px auto; background:#f8f8f8; overflow:hidden; border-radius:7px}
...
.forgot-password span.icon{width:50px; transition:all 800ms; text-align:center; color:#999; height:40px; border-radius:0 3px 3px 0; background:#e8e8e8; height:40px; line-height:40px; display:inline-block; border:solid 1px #ccc; border-left:none; font-size:16px}
...
#forgot-password:checked~div .form-header li:nth-child(1),#signup:checked~div .form-header li:nth-child(2){background:#e8e8e8}
...
<input type="radio" checked id="forgot-password" name="switch" class="hide">
<input type="radio" id="signup" name="switch" class="hide">

<div>
<ul class="form-header">
<li><label for="forgot-password"><i class="fa fa-lock"></i> FORGOT PASSWORD</label></li>
...
<li><input type="submit" value="GET PASSWORD" class="btn"></li>
</ul>
</form>
</div>
